...
proves, the difference between a policy engine and a suggestion.
"""
...
class Broker:
    ...
    def _execute(
        ...
        if tool == "send_message":
            ...
            # The transport knows the resolved address; the agent must not.
            # Returning the transport's receipt verbatim puts the customer's
            # real email back into the agent's context one turn after the
            # record was redacted, undoing the redaction through the
